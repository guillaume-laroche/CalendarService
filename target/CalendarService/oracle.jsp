...
<body>
	...
	<p>
		<font color="#000000" size="7" face="Arial"> <font size="6">
				<a href="index.jsp"> <img src="img/GoogleServices.jpg"
					height="80" width="80" /></a><%=GCalendarService.getApplicationName()%>
		</font>
		</font>
	...
	<form name="Parameters" action="OracleServlet" method="post">
		<table>
			<tr>
				...
				<td><input type="text" name="host" id="host" maxlength="30"
					size="30"
					title="Nom ou adresse IP du serveur Oracle" value="axint.axin.local"/></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="sid" id="sid" maxlength="30"
					size="30" title="SID base Oracle"/ value="octal"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="dbuser" id="dbuser" maxlength="30"
					size="30" title="Compte utilisateur Oracle" value="gl" /></td>
			</tr>
			...
			<tr>
				<td align="center" colspan="2"><font face="Arial"> <input
						type="submit" name="submit" maxlength="50" size="50"
						value="Synchroniser" />
				</font></td>
			</tr>
		</table>
